...
INSERT IN TO specialty (specialty_name, description, image) VALUES ('Food Photography', 'Highlight the deliciousness of food with mouthwatering visual details.', 'https://backend-s3-images.s3.amazonaws.com/specialties/Food/profile-image');
